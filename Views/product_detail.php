            ...
            <div class="col-md-5 mt-5">
                <div class="d-flex">
                    <div class="d-flex flex-column gap-2 me-3 w-50" style="max-height: 500px; overflow-y: auto;" id="img_detail">
                        <?php foreach($images as $product): ?>
                                <img src="/php2/ASM/public/img/products/<?=$product?>" class="img-thumbnail thumb-img" alt="Thumbnail 1" <?= empty($product) ? 'style="display:none;"' : '' ?> style="max-width: 100%; height: auto;">
                        <?php endforeach; ?>
                    </div>
                <?php 
                ...
                ?>
                    <div class="flex-grow-1">
                        <img src="/php2/ASM/public/img/products/<?=$images[0]?>" class="img-fluid rounded main-image" alt="Main Image" style="max-width: 100%; height: auto;">
                    </div>
                </div>
            </div> 
...
<!-- <script src="/php2/ASM/public/js/selectVariants.js"></script> -->
