<div id="carouselExampleAutoplaying" class="carousel slide mt-5" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="public/img/banner/mlb_desktop_en_be560d199f054efa9d99ae5826e2cdde.webp" class="d-block w-100 img-fluid" alt="...">
        </div>
        <div class="carousel-item">
            <img src="public/img/banner/msloyalty_mlb_web.webp" class="d-block w-100 img-fluid" alt="...">
        </div>
        <div class="carousel-item">
            <img src="public/img/banner/1960x640-mua-ngay.webp" class="d-block w-100 img-fluid" alt="...">
        </div>
    </div>
...
<div class="container-xxl mt-5 text-center">
        ...
        <div class="row g-3">
            <div class="col-12 col-md-6">
                <div class="position-relative overflow-hidden">
                    <img src="public/img/banner/hangmoive_main.jpg" class="w-100 img-fluid" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-dark bg-opacity-50 hover-overlay">
                        <button type="button" class="btn btn-outline-light btn-sm">Xem tất cả</button>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-6">
    ...
    <div class="hangmoive p-2 col-12">
        <div class="row g-3">
            ...
            <div class="col-12 col-md-6">
                <div class="position-relative overflow-hidden">
                    <img src="public/img/banner/bst_hip.jfif" class="w-100 img-fluid" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center justify-content-center bg-dark bg-opacity-50 hover-overlay">
                        <button type="button" class="btn btn-outline-light btn-sm">Xem tất cả</button>
                    </div>
                </div>                
        ...
        <div class="row">
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="public/img/articles/baiviet1.jfif" alt="Card image" style="width:100%">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="public/img/articles/baiviet2.jfif" alt="Card image" style="width:100%">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="public/img/articles/baiviet3.jfif" alt="Card image" style="width:100%">
                <div class="card-img-overlay text-light w-100 mt-5">
            ...
            <div class="col-12 col-md-6 col-lg-3 mb-4">
                <div class="card img-fluid bg-dark">
                    <img class="card-img-top opacity-25" src="public/img/articles/baiviet4.jfif" alt="Card image" style="width:100%">
                <div class="card-img-overlay text-light w-100 mt-5">
