...
<main class="wrap container-xl mt-5">
    ...
    <div class="lichsumuahang shadow p-3 rounded">
        ...
        <div class="thongtinls d-flex flex-column">
            ...
            <?php for($i = 0; $i < count($names); $i++): ?>
                <div class="ttdh d-flex justify-content-start align-items-center w-100">
                    <img src="/php2/ASMC/public/img/products/<?php echo $images[$i]; ?>" class="img-thumbnail img_dh" alt="...">
        ...
        <div class="trangthai">
            ...
            <button class="xemchitiet <?=($order['status'] != "dang-giao-hang" && $order['status'] != "giao-thanh-cong" && $order['status'] != "don-that-bai") ? '' : 'd-none'; ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop_address<?=$order['id']?>">
            ...
            <div class="modal-dialog">
                ...
                <form action="/php2/ASMC/order/infor/editAddress" method="post">
                    <textarea name="address" id="address" rows="2" cols="70"><?=$order['address']?></textarea>
            ...
            <button class="xemchitiet <?=($order['status'] != "dang-giao-hang" && $order['status'] != "giao-thanh-cong" && $order['status'] != "don-that-bai") ? '' : 'd-none'; ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop_confirmCancel<?=$order['id']?>">
                Hủy 
            </button>
            <!-- Modal -->
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-footer">
                    <a class="btn btn-danger" href="/php2/ASMC/order/infor/cancel/<?=$order['id']?>">Xác nhận</a>
